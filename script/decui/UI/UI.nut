class UI  {
    ...
    constructor() {
        ...
        lists = [ [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [] ];
        names = [ "labels", "buttons", "sprites", "windows", "progbars", "canvas", "scrollbars", "memoboxes", "editboxes", "listboxes" , "checkboxes", "popups", "datatables", "comboboxes", "tabviews", "circles", "notifications", "grids", "menus", "sliders", "paginations", "searchbar", "quickdraws" ];
   ...
   function print(msg) {
    ...
    function Draw (o){  
        if (typeof o == "string") {
            local draw = this.fetch.canvas(o);
            if (draw != null) {
                return draw.context;
            } else{
                return null;
    ...
    function Searchbar (o){  
        if (typeof o == "string") {
            local search = this.fetch.canvas(o);
            if (search != null) {
