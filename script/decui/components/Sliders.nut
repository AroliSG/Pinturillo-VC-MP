class Sliders extends Component {
    ...
    attachShadow = function (w=null,h=null,debug=null) {
        ...
        if (context.direction == "horizontal") {
            ...
            if (context.buttonAlign == "mid_left") {
                if (GUI.GetMousePos () != null && this.IsValue ==null) b.Pos.X = GUI.GetMousePos ().X - c.Pos.X;
            ...
            if (context.buttonAlign == "bottom") {
                if (GUI.GetMousePos () != null  && this.IsValue ==null) b.Pos.Y = GUI.GetMousePos ().Y - c.Pos.Y;
                if (context.setshadow != null) {   
    ...
    attachToMouse = function () {
        if (this.mouseTimer == null && this.IsValue ==null) {
